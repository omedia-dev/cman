...
/**
 * Template Name: Личный кабинет (аренда)
 *
        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="mainMenu">
            <ul class="main-menu user-menu navbar-nav justify-content-between w-100">
              ...
              <li class="nav-item active"><a href="/lk/rent-list/" class="nav-link">Объекты аренды</a></li>
      ...
      <div class="container inner-page">
        ...
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Объекты аренды</li>
          </ol>
        </nav>
